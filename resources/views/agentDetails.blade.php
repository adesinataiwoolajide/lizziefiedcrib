							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content col-md-12">
									<div class="modal-header text-center">
										<h4 class="modal-title w-100 font-weight-bold">Agent Properties</h4>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true"><i class="fa fa-close"></i>&times;</span>
										</button>
									</div>
									<div class="container-fluid">
										<div class="row">
											{{-- <div class="col-md-4">
												<img src="{{asset('images/maxresdefault.jpg')}}" class="img-responsive" alt="" style="height:200px; width:200px">
											</div> --}}
											<div class="cnt-block equal-hight col-md-4" style="height: 300px;">
												<img src="{{asset('agent-logo/'.$list->agent_image)}}" class="img-responsive" alt="">
												<a href=""></a>
											</div>
										</div>
										<div class="row">

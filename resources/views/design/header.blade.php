...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('smart/Smart Crib Logo/Smart_Crib_Bl_Full.jpg')}}">
...
<body class="<?php echo $body ?>">
    ...
    <div class="" style="font-family:nunitosan">
        @yield('content')  
    </div>


    <!-- START SECTION NEWSLETTER -->
     @if(($body == "Coming Soon") OR ($body == "Agent Registration"))
        ...
        <section class="testimonials">
            <div class="container">
                ...
                <div class="owl-carousel style1">
                    <div class="test-1">
                        <h3>Lisa Smith</h3>
                        <img src="{{asset('smart/images/testimonials/ts-1.jp')}}g" alt="">
                    ...
                    <div class="test-1">
                        <h3>Jhon Morris</h3>
                        <img src="{{asset('smart/images/testimonials/ts-2.jpg')}}" alt="">
                    ...
                    <div class="test-1">
                        <h3>Mary Deshaw</h3>
                        <img src="{{asset('smart/images/testimonials/ts-3.jpg')}}" alt="">
                    ...
                    <div class="test-1">
                        <h3>Gary Steven</h3>
                        <img src="{{asset('smart/images/testimonials/ts-4.jpg')}}" alt="">
                    ...
                    <div class="test-1">
                        <h3>Cristy Mayer</h3>
                        <img src="{{asset('smart/images/testimonials/ts-5.jpg')}}" alt="">
                    ...
                    <div class="test-1">
                        <h3>Ichiro Tasaka</h3>
                        <img src="{{asset('smart/images/testimonials/ts-6.jpg')}}" alt="">

...
<body>
      <div class="row">
            ...
            <div class="widget" data-toggle="modal" data-target="#modalLoginForm">
                  ...
                  <div class="modal-dialog" role="document">
                        <div class="modal-content">
                              ...
                              <div class="modal-header text-center">
                                    <h4 class="modal-title w-100 font-weight-bold">Agent Registration Form</h4>
    ...
    <div class="askQuestion">
      ...
      <script type="text/JavaScript">
            ...
            var formData = document.getElementById('myAgentForm');
                   
            formData.onsubmit = function(){
                  event.preventDefault();
                  var formData1 = document.getElementById('myAgentForm');
                  var dataForm = new FormData(formData1);
                        dataForm.append('something', 'alalalalala');
                  var theToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
                  var xhttp = new XMLHttpRequest();
                  xhttp.open('POST', '/addAgent', true);
